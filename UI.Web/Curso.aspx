<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Curso.aspx.cs" Inherits="UI.Web.Curso" %>

<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <asp:Panel ID="gridPanel" runat="server">
        <asp:GridView ID="dgvCurso" runat="server" AutoGenerateColumns="False"
             SelectedRowStyle-BackColor="Black"
             SelectedRowStyle-ForeColor="White"
             DataKeyNames="ID" OnSelectedIndexChanged="dgvCurso_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField HeaderText="Materia ID" DataField="IDMateria" />
                <asp:BoundField HeaderText="Comision ID" DataField="IDComision" />
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server">
        <asp:Label ID="lblIDmateria" runat="server" Text="Materia ID"></asp:Label>
        <asp:DropDownList ID="ddlIDmateria" runat="server"></asp:DropDownList>
        <br />
        <asp:Label ID="lblIDcomision" runat="server" Text="Comision ID"></asp:Label>
        <asp:DropDownList ID="ddlIDcomision" runat="server"></asp:DropDownList>
        <br />
        ...
        <br />
        <asp:Label ID="lblCupo" runat="server">Cupo</asp:Label>
